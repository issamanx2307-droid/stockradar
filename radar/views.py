...
def _try_ai_reply(user, admin_user, user_message: str):
    ...
    system_prompt = (
        ...
        "- RSI: <30=Oversold, 30-70=ปานกลาง, >70=Overbought\n"
        ...
        "- ATR14: ความผันผวนรายวัน (ยิ่งสูง=ผันผวนมาก)\n"
        "- volume_ratio: Volume วันนี้ ÷ ค่าเฉลี่ย 20 วัน (>1.5=ปริมาณสูงผิดปกติ)\n"
        "- highest_high_20/lowest_low_20: แนวต้าน/แนวรับ 20 วันล่าสุด\n\n"
        ...
        "**Momentum**\n"
        "RSI: 57.2 (ปานกลาง)\n"
        "MACD Hist: 0.09 (โมเมนตัมบวก)\n\n"
        "**Bollinger Bands**\n"
        "Upper: 35.50 | Middle: 34.00 | Lower: 32.50\n"
        "ราคาอยู่กลาง BB\n\n"
        "**Trend Strength (ADX/DMI)**\n"
        "ADX: 28.5 (trend แข็ง) | DI+: 22.1 | DI-: 15.3\n\n"
        "**Volume**\n"
        "ปริมาณวันนี้: 12,500,000 หุ้น\n"
        "เฉลี่ย 20 วัน: 10,000,000 หุ้น (1.25×)\n\n"
