...
const MENU_GUIDE: MenuItem[] = [
  {
    ...
    sections: [
      ...
      { title: "🗂️ Tab สัญญาณ", items: [
        "ทั้งหมด — ทุกสัญญาณ",
        "สัญญาณซื้อ 🟢 — BUY, STRONG_BUY, GOLDEN_CROSS, EMA Align ฯลฯ",
        "สัญญาณขาย 🔴 — SELL, DEATH_CROSS, BREAKDOWN ฯลฯ",
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "🃏 ScoreCard + Analyze Panel", items: [
        ...
        "แสดง: Score Ring, Entry / Stop Loss / Risk % / RSI / ADX",
        "Score Breakdown แยกรายด้าน (Trend / Momentum / Volume / Volatility)",
        "เหตุผลที่ Engine เลือกหุ้นนี้ (ภาษาไทย)",
        "ปุ่ม 📈 กราฟ เปิดหน้ากราฟต่อได้ทันที",
      ]},
      { title: "📊 Summary Badges", items: [
        "ด้านบน Grid นับจำนวนหุ้นที่เป็น STRONG BUY / BUY / HOLD / WATCH / SELL",
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "📊 ผลวิเคราะห์", items: [
        "Decision Badge: STRONG BUY / BUY / HOLD / WATCH / SELL",
        "Score 0–100 (คะแนนรวม)",
        "Entry Price — ราคาที่ควรเข้าซื้อ",
        "Stop Loss — ราคา Stop Loss ที่แนะนำ (อิง ATR)",
        "Risk % — ความเสี่ยงต่อ trade",
        "RSI / ADX — ค่า Indicator ปัจจุบัน",
      ]},
      { title: "📉 Score Breakdown (4 แท่ง)", items: [
        "📈 Trend (max 40) — ราคาอยู่เหนือ EMA กี่เส้น, ทิศทาง",
        "🚀 Momentum (max 25) — RSI zone, MACD direction",
        "📢 Volume (max 15) — Volume สูงกว่าค่าเฉลี่ยไหม",
        "⚡ Volatility (max 10) — ATR, BB Width ในระดับที่เหมาะสม",
      ]},
